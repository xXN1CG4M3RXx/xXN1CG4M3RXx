...
import { User, Code, Monitor, Mail, Terminal, Gamepad2 } from "lucide-react";

export default function Navbar() {
  return (
    <div className="fixed bottom-6 left-1/2 -translate-x-1/2 z-50">
      <nav className="glassmorphism rounded-full px-6 py-3 flex items-center gap-6 sm:gap-8 border border-sky-aqua-500/20 shadow-lg shadow-sky-aqua-900/20">
        <NavLink 
          to="/" 
          end
          className={({ isActive }) => 
        ...
        >
          <Gamepad2 size={20} />
          <span className="text-[10px] uppercase font-mono tracking-widest">Interests</span>
        </NavLink>
