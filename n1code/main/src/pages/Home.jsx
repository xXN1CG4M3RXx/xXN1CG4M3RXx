...
export default function Home() {
  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-center p-6 mb-24 w-full min-h-screen relative" style={getBackgroundStyle()}>
